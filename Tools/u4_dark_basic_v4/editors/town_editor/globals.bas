...
Y1 = Int((icon_temp / 15) * 15) - ((X1 - 1) * 15) + 1
blah = BitBlt(main.dest.hDC, (Xt * 16 - 15), (Yt * 16 - 15), 16, 16, icons.src.hDC, X1 * 16 - 16, Y1 * 16 - 16, &HCC0020)
Next Xt
Next Yt
main.dest.Refresh
End Sub
...
Y1 = Int((npc.tile_start / 15) * 15) - ((X1 - 1) * 15) + 1
blah = BitBlt(main.dest.hDC, (npc.X * 16 - 15), (npc.Y * 16 - 15), 16, 16, icons.src.hDC, X1 * 16 - 16, Y1 * 16 - 16, &HCC0020)
