...
**************************************************************************************************************************
U4 version 7.0317
-May have fixed flicker by adding code to Y/ell command - try the Y/ell command and type in sync. If not, try
looking at Z/tats and see if that works.
**************************************************************************************************************************
U4 version 7.0308
-Fixed delay on startup
-Changed game resolution to 1024x768 due to many video cards not supporting 800x600 on widescreen LCD

**************************************************************************************************************************
U4 version 6.0925
-Fixed crash during rune creation that can occur at times
**************************************************************************************************************************
U4 version 4.0528
-U5 tileset added. Removed original U4 set
-Fixed bugs introduced by new tileset. (too many to list)
-Dead and Sleeping NPC's/PC's in battle now use better icons to depict state
-.MAP format now fully 16bit .ULT format 16bit town map and 8bit NPC descriptors
-Original SaveGame compatible with this version
-Editors updated to use U5 tileset. Also fixed a few small issues with each editor.
-Intro uses U5 tileset now
-New intro game splash screen standard. User can change this, but not tileset now
-Horses and horseback riding uses U5 tileset now
-All towns have extra U5 icon content
-Restored orginal moongate tileset
-many more layers introduced
-Rebalanced game damage with all weapons
-Missing frigate after re-entering cove fixed by editing frigate.ini and replacing one entry with 092,129. Save and restart game
...
One can download the current version from http://www.wizardportal.shorturl.com
