...
ANI_Moongates()
{
    D_9445 = D_0814[(Party._trammel & 0xe0) >> 5];
    D_9448 = D_081C[(Party._trammel & 0xe0) >> 5];
    return ((D_1664 & 0xc0) >> 6);
}

unsigned D_1668 = 0;

/*display trammel and felucca ?*/
ANI_Moons()
{
    ...
    if(D_1668-- == 0) {
        ...
        if((Party._trammel & 0x1f) == 0) {
            D_9141 = ANI_Moongates() + 0x40;
        } else if((Party._trammel & 0x1f) == 0x1e){
            D_9141 = (ANI_Moongates() ^ 3) + 0x40;
        }
    }
    bp_02 = txt_X;
    bp_04 = txt_Y;
    txt_Y = 0;
    txt_X = 11;
    Gra_putchar((((Party._trammel >> 5) - 1) & 7) + 0x14);
    txt_X ++;
    Gra_putchar((((Party._felucca >> 5) - 1) & 7) + 0x14);
    txt_X = bp_02;
    txt_Y = bp_04;
}
...
C_3B35()
{
	...
	ANI_Moons();/*display trammel and felucca*/
	loc_B = 10 * 11 + 10;
